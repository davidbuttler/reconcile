...
import reconcile.weka.classifiers.trees.m5.M5Base;
import reconcile.weka.classifiers.trees.m5.Rule;
...
public class M5P extends M5Base 
  ...
  public static void main(String[] args) {
    try {
      System.out.println(reconcile.weka.classifiers.Evaluation.evaluateModel(
			 new M5P(), 
			 args));
    } catch (Exception e) {
