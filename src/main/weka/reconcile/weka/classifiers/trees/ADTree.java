...
import reconcile.weka.classifiers.IterativeClassifier;
import reconcile.weka.classifiers.trees.adtree.PredictionNode;
import reconcile.weka.classifiers.trees.adtree.ReferenceInstances;
import reconcile.weka.classifiers.trees.adtree.Splitter;
import reconcile.weka.classifiers.trees.adtree.TwoWayNominalSplit;
import reconcile.weka.classifiers.trees.adtree.TwoWayNumericSplit;
				...
				IterativeClassifier
{
  ...
  private void updateWeights(Instances posInstances, Instances negInstances,
    ...
    for (Enumeration e = posInstances.enumerateInstances(); e.hasMoreElements(); ) {
      Instance inst = (Instance) e.nextElement();
      inst.setWeight((float)(inst.weight() * weightMultiplier));
    }
    // do negatives
