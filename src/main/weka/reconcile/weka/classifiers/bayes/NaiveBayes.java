...
import reconcile.weka.estimators.NormalEstimator;
...
public class NaiveBayes extends Classifier 
   ...
   */
  protected reconcile.weka.filters.supervised.attribute.Discretize m_Disc = null;
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_UseDiscretization) {
      m_Disc = new reconcile.weka.filters.supervised.attribute.Discretize();
      m_Disc.setInputFormat(m_Instances);
      m_Instances = reconcile.weka.filters.Filter.useFilter(m_Instances, m_Disc);
    } else {
      m_Disc = null;
    }
