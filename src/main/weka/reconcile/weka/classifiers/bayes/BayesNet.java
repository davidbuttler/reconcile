...
import reconcile.weka.classifiers.bayes.net.ADNode;
import reconcile.weka.classifiers.bayes.net.BIFReader;
import reconcile.weka.classifiers.bayes.net.ParentSet;
import reconcile.weka.classifiers.bayes.net.estimate.BayesNetEstimator;
import reconcile.weka.classifiers.bayes.net.estimate.DiscreteEstimatorBayes;
import reconcile.weka.classifiers.bayes.net.estimate.SimpleEstimator;
import reconcile.weka.classifiers.bayes.net.search.SearchAlgorithm;
import reconcile.weka.classifiers.bayes.net.search.local.K2;
import reconcile.weka.classifiers.bayes.net.search.local.LocalScoreSearchAlgorithm;
import reconcile.weka.classifiers.bayes.net.search.local.Scoreable;
...
import reconcile.weka.filters.supervised.attribute.Discretize;
    ...
    static {
        try {
            java.beans.PropertyEditorManager.registerEditor(
                reconcile.weka.classifiers.bayes.net.search.SearchAlgorithm.class,
                reconcile.weka.gui.GenericObjectEditor.class);
            java.beans.PropertyEditorManager.registerEditor(
                reconcile.weka.classifiers.bayes.net.estimate.BayesNetEstimator.class,
                reconcile.weka.gui.GenericObjectEditor.class);
        } catch (Throwable t) {
            // ignore
        }
