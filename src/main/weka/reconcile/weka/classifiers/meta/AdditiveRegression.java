...
import reconcile.weka.classifiers.IteratedSingleClassifierEnhancer;
...
public class AdditiveRegression extends IteratedSingleClassifierEnhancer 
  ...
  public AdditiveRegression() {
    ...
    this(new reconcile.weka.classifiers.trees.DecisionStump());
  }
  ...
  private Instances residualReplace(Instances data, Classifier c, 
	...
	pred *= getShrinkage();
      ...
      newInst.instance(i).setClassValue((float)residual);
    }
