...
public class FilteredClassifier extends SingleClassifierEnhancer implements Drawable {
  ...
  /** The filter */
  protected Filter m_Filter = new reconcile.weka.filters.supervised.attribute.AttributeSelection();
  ...
  public FilteredClassifier() {
    ...
    m_Filter = new reconcile.weka.filters.supervised.attribute.Discretize();
  }
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new reconcile.weka.filters.supervised.attribute.Discretize());
    }
