...
import reconcile.weka.classifiers.lazy.IBk;
...
public class DecisionTable extends Classifier 
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_theInstances.classAttribute().isNumeric()) {
      m_disTransform = new reconcile.weka.filters.unsupervised.attribute.Discretize();
      m_classIsNominal = false;
      
      // use binned discretisation if the class is numeric
      ((reconcile.weka.filters.unsupervised.attribute.Discretize)m_disTransform).
	setBins(10);
      ((reconcile.weka.filters.unsupervised.attribute.Discretize)m_disTransform).
	...
	setAttributeIndices(rangeList);
      ...
      m_disTransform = new reconcile.weka.filters.supervised.attribute.Discretize();
      ((reconcile.weka.filters.supervised.attribute.Discretize)m_disTransform).setUseBetterEncoding(true);
