...
public class RuleStats implements Serializable{
  ...
  public void addAndUpdate(Rule lastRule) {
    ...
    Instances data = (m_Filtered == null)?m_Data:((Instances[])m_Filtered
        .lastElement())[1];
  ...
  public static double dataDL(double expFPOverErr, double cover,
     ...
     * "|coverBits: "+coverBits+"|uncBits: "+ uncoverBits+ "|FPRate:
     * "+expFPOverErr + "|expErr: "+expErr+ "|fp: "+fp+"|fn: "+fn+"|total:
     * "+totalBits);
     */
  ...
  public double potential(int index, double expFPOverErr, double[] rulesetStat,
    ...
    System.out.println("!!!inside potential: "
        + ((JRip.RipperRule)m_Ruleset.elementAt(index)).toString(null));
