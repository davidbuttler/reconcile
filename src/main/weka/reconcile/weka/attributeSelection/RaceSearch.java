...
import reconcile.weka.experiment.PairedStats;
import reconcile.weka.experiment.Stats;
  ...
  public int[] search (ASEvaluation ASEval, Instances data)
    ...
    if (!(ASEval instanceof HoldOutSubsetEvaluator)) {
      throw new Exception("Must use a HoldOutSubsetEvaluator, eg. "
        + "reconcile.weka.attributeSelection.ClassifierSubsetEval "
			  +"(RaceSearch)");
    }

    if (!(ASEval instanceof ErrorBasedMeritEvaluator)) {
      throw new Exception("Only error based subset evaluators can be used, "
        + "eg. reconcile.weka.attributeSelection.ClassifierSubsetEval "
			  +"(RaceSearch)");
    }
