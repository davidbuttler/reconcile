...
import reconcile.weka.classifiers.functions.SMO;
...
public class SVMAttributeEval extends AttributeEvaluator
  ...
  private int[] rankBySVM(int classInd, Instances data) {
	...
	reconcile.weka.filters.unsupervised.attribute.Remove delTransform =
	  new reconcile.weka.filters.unsupervised.attribute.Remove();
