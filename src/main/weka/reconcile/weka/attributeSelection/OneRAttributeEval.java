  ...
  extends AttributeEvaluator implements OptionHandler
{
  ...
  Classifier oneR = Classifier.forName("reconcile.weka.classifiers.rules.OneR", oneROpts);
    if (m_evalUsingTrainingData) {
      oneR.buildClassifier(trainCopy);
      o_Evaluation.evaluateModel(oneR, trainCopy);
    } else {
    /*      o_Evaluation.crossValidateModel("reconcile.weka.classifiers.rules.OneR", 
      trainCopy, 10, 
