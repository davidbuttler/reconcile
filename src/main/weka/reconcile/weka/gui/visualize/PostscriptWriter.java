...
public class PostscriptWriter extends JComponentWriter {
  ...
  public static void main(String[] args) throws Exception {
    ...
    reconcile.weka.gui.treevisualizer.TreeBuild builder = new reconcile.weka.gui.treevisualizer.TreeBuild();
    reconcile.weka.gui.treevisualizer.NodePlace arrange = new reconcile.weka.gui.treevisualizer.PlaceNode2();
    reconcile.weka.gui.treevisualizer.Node top = builder.create(new java.io.StringReader("digraph atree { top [label=\"the top\"] a [label=\"the first node\"] b [label=\"the second nodes\"] c [label=\"comes off of first\"] top->a top->b b->c }"));
    reconcile.weka.gui.treevisualizer.TreeVisualizer tv = new reconcile.weka.gui.treevisualizer.TreeVisualizer(null, top, arrange);
    tv.setSize(800 ,600);
