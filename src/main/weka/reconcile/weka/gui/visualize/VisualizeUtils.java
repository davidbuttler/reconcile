...
protected static String PROPERTY_FILE = "reconcile/weka/gui/visualize/Visualize.props";
  ...
  static {
    ...
    try {
      ...
      String precision = 
 VISUALIZE_PROPERTIES.getProperty("reconcile.weka.gui.visualize.precision");
      if (precision == null) {
	/*
