...
package reconcile.weka.gui.boundaryvisualizer;
...
import reconcile.weka.experiment.Compute;
import reconcile.weka.experiment.RemoteExperimentEvent;
import reconcile.weka.experiment.RemoteExperimentListener;
import reconcile.weka.experiment.TaskStatusInfo;
...
public class BoundaryPanelDistributed extends BoundaryPanel {
  ...
  private reconcile.weka.core.Queue m_remoteHostsQueue = new reconcile.weka.core.Queue();
  ...
  private reconcile.weka.core.Queue m_subExpQueue = new reconcile.weka.core.Queue();
  ...
  protected void initialize() {
    ...
    m_remoteHostsQueue = new reconcile.weka.core.Queue();
    ...
    m_subExpQueue = new reconcile.weka.core.Queue();
