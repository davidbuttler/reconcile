...
public final static String[] IMAGES = { "reconcile/weka/gui/", "reconcile/weka/gui/images/" };
  ...
  public static int showMessageBox(Component parent, String title, String msg, int buttons, int messageType) { 
    ...
    switch (messageType) {
      ...
      icon = "reconcile/weka/gui/images/error.gif";
      break;
    case JOptionPane.INFORMATION_MESSAGE:
      icon = "reconcile/weka/gui/images/information.gif";
      break;
    case JOptionPane.WARNING_MESSAGE:
      icon = "reconcile/weka/gui/images/information.gif";
      break;
    case JOptionPane.QUESTION_MESSAGE:
      icon = "reconcile/weka/gui/images/question.gif";
      break;
    default:
      icon = "reconcile/weka/gui/images/information.gif";
      break;
