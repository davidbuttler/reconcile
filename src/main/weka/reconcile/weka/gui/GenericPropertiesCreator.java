...
import reconcile.weka.core.RTSI;
...
public class GenericPropertiesCreator {
   ...
   * @see #PROPERTY_FILE
   */
protected static String CREATOR_FILE = "reconcile/weka/gui/GenericPropertiesCreator.props";
...
protected static String PROPERTY_FILE = "reconcile/weka/gui/GenericObjectEditor.props";
  ...
  protected boolean isValidClassname(String key, String classname) {
    ...
    if (key.equals(reconcile.weka.experiment.ResultListener.class.getName())) {
      try {
        cls = Class.forName(classname);
        if (RTSI.hasInterface(reconcile.weka.experiment.ResultProducer.class, cls))
          result = false;
      }
      catch (Exception e) {
