...
import reconcile.weka.core.converters.DatabaseConverter;
import reconcile.weka.core.converters.DatabaseSaver;
...
public class Saver extends AbstractDataSink implements WekaWrapper {
   ...
   * Saver
   */
  private reconcile.weka.core.converters.Saver m_Saver= new ArffSaver();
   ...
   * @param saver a Saver
   */
  public void setSaver(reconcile.weka.core.converters.Saver saver) {
   ...
   */
  public reconcile.weka.core.converters.Saver getSaver() {
    return m_Saver;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) 
    ...
    if (!(algorithm instanceof reconcile.weka.core.converters.Saver)) { 
      throw new IllegalArgumentException(algorithm.getClass()+" : incorrect "
					 +"type of algorithm (Loader)");
    }
    setSaver((reconcile.weka.core.converters.Saver)algorithm);
  }
