...
package reconcile.weka.gui.beans.xml;
...
import reconcile.weka.core.xml.XMLDocument;
import reconcile.weka.gui.beans.BeanConnection;
import reconcile.weka.gui.beans.BeanInstance;
import reconcile.weka.gui.beans.BeanVisual;
import reconcile.weka.gui.beans.MetaBean;
import reconcile.weka.gui.beans.Visible;
...
public class XMLBeans 
  ...
  * (Instances and Connections are stored in a Vector and then serialized) */
  ...
  public void clear() throws Exception {
    ...
    // allow
    m_Properties.addAllowed(reconcile.weka.gui.beans.BeanInstance.class, "x");
    m_Properties.addAllowed(reconcile.weka.gui.beans.BeanInstance.class, "y");
    m_Properties.addAllowed(reconcile.weka.gui.beans.BeanInstance.class, "bean");
    m_Properties.addAllowed(reconcile.weka.gui.beans.Saver.class, "saver");
    m_Properties.addAllowed(reconcile.weka.gui.beans.Loader.class, "loader");
    if (getDataType() == DATATYPE_LAYOUT)
      m_Properties.addAllowed(reconcile.weka.gui.beans.Loader.class, "beanContext");
    else
      m_Properties.addIgnored(reconcile.weka.gui.beans.Loader.class, "beanContext");   // TODO: more classes???
    m_Properties.addAllowed(reconcile.weka.gui.beans.Filter.class, "filter");
    m_Properties.addAllowed(reconcile.weka.gui.beans.Classifier.class, "wrappedAlgorithm");
    m_Properties.addAllowed(reconcile.weka.gui.beans.Clusterer.class, "wrappedAlgorithm");
    ...
    m_Properties.addAllowed(reconcile.weka.filters.Filter.class, "options");
    
    m_Properties.addAllowed(reconcile.weka.core.converters.DatabaseSaver.class, "options");
    m_Properties.addAllowed(reconcile.weka.core.converters.DatabaseLoader.class, "options");

    // we assume that classes implementing SplitEvaluator also implement OptionHandler
    m_Properties.addAllowed(reconcile.weka.experiment.SplitEvaluator.class, "options");
    // we assume that classes implementing ResultProducer also implement OptionHandler
    m_Properties.addAllowed(reconcile.weka.experiment.ResultProducer.class, "options");
    ...
    m_CustomMethods.register(this, reconcile.weka.gui.beans.BeanInstance.class, "BeanInstance");
    m_CustomMethods.register(this, reconcile.weka.gui.beans.BeanConnection.class, "BeanConnection");
    m_CustomMethods.register(this, reconcile.weka.gui.beans.BeanVisual.class, "BeanVisual");
    m_CustomMethods.register(this, reconcile.weka.gui.beans.Saver.class, "BeanSaver");
    m_CustomMethods.register(this, reconcile.weka.gui.beans.MetaBean.class, "MetaBean");
    
    m_CustomMethods.register(this, reconcile.weka.core.converters.ArffLoader.class, "Loader");
    m_CustomMethods.register(this, reconcile.weka.core.converters.ArffSaver.class, "Saver");
    m_CustomMethods.register(this, reconcile.weka.core.converters.C45Loader.class, "Loader");
    m_CustomMethods.register(this, reconcile.weka.core.converters.C45Saver.class, "Saver");
    m_CustomMethods.register(this, reconcile.weka.core.converters.CSVLoader.class, "Loader");
    m_CustomMethods.register(this, reconcile.weka.core.converters.CSVSaver.class, "Saver");
    m_CustomMethods.register(this, reconcile.weka.core.converters.SerializedInstancesLoader.class, "Loader");
    m_CustomMethods.register(this, reconcile.weka.core.converters.SerializedInstancesSaver.class, "Saver");
  ...
  public Object readBeanInstance(Element node) throws Exception {
    ...
    if (beaninst.getBean() instanceof reconcile.weka.gui.beans.Visible) {
  ...
  public Element writeBeanLoader(Element parent, Object o, String name)
    ...
    Element                 node;
    reconcile.weka.gui.beans.Loader   loader;
    ...
    loader = (reconcile.weka.gui.beans.Loader) o;
  ...
  public Element writeBeanSaver(Element parent, Object o, String name)
    ...
    Element                 node;
    reconcile.weka.gui.beans.Saver    saver;
    File                    file;
    ...
    saver = (reconcile.weka.gui.beans.Saver) o;
  ...
  public Element writeLoader(Element parent, Object o, String name)
    ...
    Element                       node;
    reconcile.weka.core.converters.Loader   loader;
    File                          file;
    boolean                       known;
    ...
    loader = (reconcile.weka.core.converters.Loader) o;
    node   = addElement(parent, name, loader.getClass().getName(), false);
    known  = true;
    file   = null;

    // file
    if (loader instanceof reconcile.weka.core.converters.ArffLoader)
      file = ((reconcile.weka.core.converters.ArffLoader) loader).retrieveFile();
    else if (loader instanceof reconcile.weka.core.converters.C45Loader)
      file = ((reconcile.weka.core.converters.C45Loader) loader).retrieveFile();
    else if (loader instanceof reconcile.weka.core.converters.CSVLoader)
      file = ((reconcile.weka.core.converters.CSVLoader) loader).retrieveFile();
    else if (loader instanceof reconcile.weka.core.converters.SerializedInstancesLoader)
      file = ((reconcile.weka.core.converters.SerializedInstancesLoader) loader).retrieveFile();
    else
      known = false;
  ...
  public Object readLoader(Element node) throws Exception {
    ...
    if (file != null) {
      fl = new File(file);
      if (fl.exists())
        ((reconcile.weka.core.converters.AbstractLoader) result).setSource(fl);
      else
  ...
  public Element writeSaver(Element parent, Object o, String name)
    ...
    Element                     node;
    reconcile.weka.core.converters.Saver  saver;
    File                        file;
    boolean                     known;
    ...
    saver = (reconcile.weka.core.converters.Saver) o;
    node   = addElement(parent, name, saver.getClass().getName(), false);
    known = true;
    file  = null;

    // file
    if (saver instanceof reconcile.weka.core.converters.ArffSaver)
      file = ((reconcile.weka.core.converters.ArffSaver) saver).retrieveFile();
    else if (saver instanceof reconcile.weka.core.converters.C45Saver)
      file = ((reconcile.weka.core.converters.C45Saver) saver).retrieveFile();
    else if (saver instanceof reconcile.weka.core.converters.CSVSaver)
      file = ((reconcile.weka.core.converters.CSVSaver) saver).retrieveFile();
    else if (saver instanceof reconcile.weka.core.converters.SerializedInstancesSaver)
      file = ((reconcile.weka.core.converters.SerializedInstancesSaver) saver).retrieveFile();
    else
      known = false;
  ...
  public Object readSaver(Element node) throws Exception {
    ...
    if (file != null) {
      ((reconcile.weka.core.converters.AbstractSaver) result).setFile(new File(file));
      ((reconcile.weka.core.converters.AbstractSaver) result).setDestination(new File(file));
    }
