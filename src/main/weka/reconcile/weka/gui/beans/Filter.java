...
import reconcile.weka.filters.AllFilter;
...
public class Filter extends JPanel
   ...
   * The filter to use.
   */
  private reconcile.weka.filters.Filter m_Filter = new AllFilter();
   ...
   */
  public void setFilter(reconcile.weka.filters.Filter c) {
  ...
  public reconcile.weka.filters.Filter getFilter() {
    return m_Filter;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof reconcile.weka.filters.Filter)) { 
      throw new IllegalArgumentException(algorithm.getClass()+" : incorrect "
					 +"type of algorithm (Filter)");
    }
    setFilter((reconcile.weka.filters.Filter)algorithm);
  }
		...
		try {
		  if (m_trainingSet != null) {
		    ...
		    Instances filteredData = 
		      reconcile.weka.filters.Filter.useFilter(m_trainingSet, m_Filter);
		    m_visual.setText(oldText);
		    m_visual.setStatic();
		    EventObject ne;
		    if (e instanceof TrainingSetEvent) {
		      ne = new TrainingSetEvent(reconcile.weka.gui.beans.Filter.this, 
						filteredData);
			...
			((TrainingSetEvent)e).m_maxSetNumber;
		      ...
		      ne = new DataSetEvent(reconcile.weka.gui.beans.Filter.this,
					    filteredData);
		    }
	...
	m_filterThread = new Thread() {
		...
		if (m_testingSet != null) {
		  ...
		  Instances filteredTest = 
		    reconcile.weka.filters.Filter.useFilter(m_testingSet, m_Filter);
		  m_visual.setText(oldText);
		  m_visual.setStatic();
		  TestSetEvent ne =
		    new TestSetEvent(reconcile.weka.gui.beans.Filter.this,
				     filteredTest);
