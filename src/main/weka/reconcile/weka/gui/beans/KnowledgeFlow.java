  ...
  public static void startApp() {
    KnowledgeFlowApp.addStartupListener(new StartUpListener() {
        public void startUpComplete() {
          reconcile.weka.gui.SplashWindow.disposeSplash();
        }
      });
                                        
    reconcile.weka.gui.SplashWindow.splash(ClassLoader.
getSystemResource("reconcile/weka/gui/beans/icons/splash.jpg"));

    Thread nt = new Thread() {
        @Override
        public void run() {
      reconcile.weka.gui.SplashWindow.invokeMethod("reconcile.weka.gui.beans.KnowledgeFlowApp",
    ...
    public static void main(String[] args) {
      reconcile.weka.gui.SplashWindow.splash(ClassLoader.
getSystemResource("reconcile/weka/gui/beans/icons/splash.jpg"));
  reconcile.weka.gui.SplashWindow.invokeMain("reconcile.weka.gui.beans.KnowledgeFlowApp", args);
      reconcile.weka.gui.SplashWindow.disposeSplash();
    }
