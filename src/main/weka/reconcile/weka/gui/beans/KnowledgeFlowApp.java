...
import reconcile.weka.core.xml.KOML;
import reconcile.weka.gui.ExtensionFileFilter;
import reconcile.weka.gui.GenericObjectEditor;
import reconcile.weka.gui.GenericPropertiesCreator;
import reconcile.weka.gui.HierarchyPropertyParser;
import reconcile.weka.gui.LogPanel;
import reconcile.weka.gui.LookAndFeel;
import reconcile.weka.gui.beans.xml.XMLBeans;
import reconcile.weka.gui.visualize.PrintablePanel;
...
public class KnowledgeFlowApp extends JPanel implements PropertyChangeListener {
   ...
   */
protected static String PROPERTY_FILE = "reconcile/weka/gui/beans/Beans.props";
  ...
  static {
	...
	if (beanCompName != null) {
	  ...
	  String wekaAlgs = GEOProps.getProperty(geoKey);
          ...
          while (enm.hasMoreElements()) {
            ...
            reconcile.weka.gui.HierarchyPropertyParser hpp = 
              new reconcile.weka.gui.HierarchyPropertyParser();
            hpp.build(classes, ", ");
	...
	BEAN_PROPERTIES.
getProperty("reconcile.weka.gui.beans.KnowledgeFlow.standardToolBars");
	 ...
	 String toolBarContents = 
	   BEAN_PROPERTIES.
getProperty("reconcile.weka.gui.beans.KnowledgeFlow." + tempBarName);
  ...
  private void setUpToolBars() {
    ...
    for (int i = 0; i < TOOLBARS.size(); i++) {
      ...
      String rootPackage = "";
      reconcile.weka.gui.HierarchyPropertyParser hpp = null;
      Hashtable hpps = null;
  ...
  private void popupHelp() {
    ...
    try {
      ...
      InputStream inR = 
	ClassLoader.
getSystemResourceAsStream("reconcile/weka/gui/beans/README_KnowledgeFlow");
