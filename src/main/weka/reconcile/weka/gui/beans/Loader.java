...
import reconcile.weka.core.converters.ArffLoader;
import reconcile.weka.core.converters.DatabaseLoader;
import reconcile.weka.core.converters.FileSourcedConverter;
...
public class Loader extends AbstractDataSource 
   ...
   * Loader
   */
  private reconcile.weka.core.converters.Loader m_Loader = new ArffLoader();
   ...
   */
  public void setLoader(reconcile.weka.core.converters.Loader loader) {
   ...
   */
  public reconcile.weka.core.converters.Loader getLoader() {
    return m_Loader;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) 
    ...
    if (!(algorithm instanceof reconcile.weka.core.converters.Loader)) { 
      throw new IllegalArgumentException(algorithm.getClass()+" : incorrect "
					 +"type of algorithm (Loader)");
    }
    setLoader((reconcile.weka.core.converters.Loader)algorithm);
  }
  ...
  public boolean eventGeneratable(String eventName) {
    if (eventName.compareTo("instance") == 0) {
      if (!(m_Loader instanceof reconcile.weka.core.converters.IncrementalConverter)) {
	return false;
      }
      if (m_dataSetEventTargets > 0) {
	return false;
    ...
    if (eventName.compareTo("dataSet") == 0) {
      if (!(m_Loader instanceof reconcile.weka.core.converters.BatchConverter)) {
	return false;
      }
