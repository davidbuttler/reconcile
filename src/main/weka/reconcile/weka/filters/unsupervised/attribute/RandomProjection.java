  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {      
    ...
    */
	...
	if( i!=instanceInfo.classIndex() && instanceInfo.attribute(i).isNominal() ) {
            if(instanceInfo.classIndex()>=0)
                ntob = new reconcile.weka.filters.supervised.attribute.NominalToBinary();
            else
                ntob = new reconcile.weka.filters.unsupervised.attribute.NominalToBinary();
	...
	replaceMissing = new reconcile.weka.filters.unsupervised.attribute.ReplaceMissingValues();
