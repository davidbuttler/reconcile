...
public class Instance implements Copyable, Serializable {
  ...
  protected static final float MISSING_VALUE = Float.NaN;
   ...
   */
  //@ ensures m_Dataset == null;
  public Instance(float weight,  /*@non_null@*/ float[]attValues){
   ...
   */
  public /*@pure@*/ static float missingValue() {
  ...
  public final void setValue(int attIndex, String value) {
    ...
    setValue(attIndex, (float)valIndex); 
  }
  ...
  public final void setValue(Attribute att, String value) {
    ...
    setValue(att.index(), (float)valIndex);
  }
