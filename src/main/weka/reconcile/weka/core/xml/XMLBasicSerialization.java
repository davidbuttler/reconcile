...
public class XMLBasicSerialization extends XMLSerialization {
   ...
   public void clear() throws Exception {
      ...
      // Weka classes
      m_CustomMethods.register(this, reconcile.weka.core.matrix.Matrix.class, "Matrix");
      m_CustomMethods.register(this, reconcile.weka.core.Matrix.class, "MatrixOld");
      m_CustomMethods.register(this, reconcile.weka.classifiers.CostMatrix.class, "CostMatrixOld");
   }
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see reconcile.weka.core.matrix.Matrix
    */
   public Element writeMatrix(Element parent, Object o, String name) 
      throws Exception {

      reconcile.weka.core.matrix.Matrix    matrix;
      Element                    node;
      ...
      matrix = (reconcile.weka.core.matrix.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrix(Element node) throws Exception {
      ...
      for (i = 0; i < children.size(); i++) {
         ...
         if (name.equals(VAL_CELLS)) {
            ...
            matrix = new reconcile.weka.core.matrix.Matrix(
                        (double[][]) o);
         }
      }
   ...
   public Element writeMatrixOld(Element parent, Object o, String name) 
      ...
      matrix = (reconcile.weka.core.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrixOld(Element node) throws Exception {
      reconcile.weka.core.Matrix           matrix;
      reconcile.weka.core.matrix.Matrix    matrixNew;
      ...
      matrixNew = (reconcile.weka.core.matrix.Matrix) readMatrix(node);
      matrix    = new reconcile.weka.core.Matrix(matrixNew.getArrayCopy());
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see reconcile.weka.classifiers.CostMatrix
    */
   ...
   public Object readCostMatrixOld(Element node) throws Exception {
      reconcile.weka.classifiers.CostMatrix   matrix;
      reconcile.weka.core.matrix.Matrix       matrixNew;
      StringWriter                  writer;
      ...
      matrix    = new reconcile.weka.classifiers.CostMatrix(new StringReader(writer.toString()));
