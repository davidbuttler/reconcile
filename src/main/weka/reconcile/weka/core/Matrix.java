...
public class Matrix 
  ...
  /**
   * The actual matrix */
  protected reconcile.weka.core.matrix.Matrix m_Matrix = null;
  ...
  public Matrix(int nr, int nc) {
    m_Matrix = new reconcile.weka.core.matrix.Matrix(nr, nc);
  }
  ...
  public Matrix(double[][] array) throws Exception {
    m_Matrix = new reconcile.weka.core.matrix.Matrix(array);
  }
  ...
  public Matrix(Reader r) throws Exception {
    m_Matrix = new reconcile.weka.core.matrix.Matrix(r);
  }
   ...
   * @see #m_Matrix
   */
  protected reconcile.weka.core.matrix.Matrix getMatrix() {
    return m_Matrix;
  }
  ...
  public int[] LUDecomposition() throws Exception {
    // decompose
    reconcile.weka.core.matrix.LUDecomposition lu = m_Matrix.lu();

    // singular? old class throws Exception!
    if (!lu.isNonsingular())
    	throw new Exception("Matrix is singular");

    reconcile.weka.core.matrix.Matrix u = lu.getU();
    reconcile.weka.core.matrix.Matrix l = lu.getL();
  ...
  public void solve(double[] bb) throws Exception {
    // solve
    reconcile.weka.core.matrix.Matrix x = m_Matrix.solve(
                                    new reconcile.weka.core.matrix.Matrix(bb, bb.length));
  ...
  public void eigenvalueDecomposition(double[][] V, double[] d) 
    ...
    reconcile.weka.core.matrix.EigenvalueDecomposition eig = m_Matrix.eig();
    reconcile.weka.core.matrix.Matrix v = eig.getV();
  ...
  protected static double hypot(double a, double b) {
    return reconcile.weka.core.matrix.Maths.hypot(a, b);
  }
  ...
  public static Matrix parseMatlab(String matlab) throws Exception {
    return new Matrix(reconcile.weka.core.matrix.Matrix.parseMatlab(matlab).getArray());
  }
