...
public class SparseInstance extends Instance {
   ...
   */
  public SparseInstance(float weight, float[] attValues) {
  ...
  public Instance mergeInstance(Instance inst) {
    ...
    return new SparseInstance((float)1.0, values, indices, numAttributes() +
			      inst.numAttributes());
  }
  ...
  /**
   * Returns the values of each attribute as an array of floats.
   *
   ...
   *
   * @param attIndex the attribute's index
   * @return the specified value as a float (If the corresponding
